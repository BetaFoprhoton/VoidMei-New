...
public class HttpHelper {
    ...
    public String sendGetURL(String url) throws Exception {
        ...
        VoidMeiMainKt.getLogger().info("Sending 'GET' request to URL: {}", url);
        VoidMeiMainKt.getLogger().info("Response Code: {}", responseCode);
