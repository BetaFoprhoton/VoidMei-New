...
//	
	...
	public static String updateLanguage(String key, String dft) {
		...
		if (!v.isEmpty()) {
//			VoidMeiMain.debugPrint(v);
			return v;
		} else {
//			VoidMeiMain.debugPrint(key);
			dft = "";
		}
		return dft;
	}
	...
	public static void initLang() {
		lanuageConfig = new Config("/lang/zh_cn.properties");
...
//		VoidMeiMain.debugPrint(httpHeader);
...
//		public static String bDrag = "主阻力面积因数与加速度系数: %.2f / %.2f\n诱导阻力因数及加速度系数: %.3f / %.0f\n散热/油冷器阻力系数: %.3f / %.3f\n";
//		
		//		VoidMeiMain.debugPrint("语言初始化完成\n");
	}
//	
