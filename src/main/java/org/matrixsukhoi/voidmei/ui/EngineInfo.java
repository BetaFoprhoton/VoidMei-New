...
public class EngineInfo extends WebFrame implements Runnable {
	...
	public void updateString() {
		...
		// totalSwitch[idx_hp] = false;
		//// VoidMeiMain.debugPrint("关闭"+idx_hp);
		// }
		// else{
		// totalSwitch[idx_hp] = true;
		// }
	...
	public void init(Controller xc, Service ts, Blkx tp) {
		...
		// 列
		if (!xc.getconfig("engineInfoColumn").isEmpty())
...
//		getWebRootPaneUI().getTitleComponent().getComponent(1).setFont(VoidMeiMain.DefaultFont);// 设置title字体
//		setAlwaysOnTop(true);
