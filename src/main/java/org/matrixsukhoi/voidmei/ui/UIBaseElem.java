...
public class UIBaseElem {
	...
	public static void drawStringShade(Graphics2D g2d, int x, int y, int shadeWidth, String s, Font f) {
		__drawStringShade(g2d, x, y, shadeWidth, s, f, VoidMeiMain.colorNum);
	}
	...
	public static void drawVBarTextNum(Graphics2D g2d, int x, int y, int width, int height, int val_height,
		...
		// 直线
		drawHRect(g2d, x, y - val_height - 1, width + 3 * numFont.getSize(), 3, 1, VoidMeiMain.colorLabel);
		// 数字
		__drawStringShade(g2d, x + width, y - val_height - 2, 1, num, numFont, VoidMeiMain.colorLabel);
	}
	...
	public static void drawHBarTextNum(Graphics2D g2d, int x, int y, int width, int height, int val_width,
		...
		// 直线
		drawVRect(g2d, x + val_width - 2, y, 3, -height - 1 * numFont.getSize(), 1, VoidMeiMain.colorLabel);
		// 数字
		__drawStringShade(g2d, x + val_width, y + height + 1 * numFont.getSize(), 1, num, numFont, VoidMeiMain.colorLabel);
	}
	public static void _drawLabelBOSType(Graphics2D g2d, int x_offset, int y_offset, int shadeWidth, int lwidth, Font num,
		...
		__drawStringShade(g2d, x_offset, (y_offset + y_offset + label.getSize() + unit.getSize()) >> 1, shadeWidth,
				sNum, num, VoidMeiMain.colorNum);

		// 标签名
		__drawStringShade(g2d, x_offset + lwidth, y_offset, shadeWidth, sLabel, label, VoidMeiMain.colorLabel);
		// 单位名
		__drawStringShade(g2d, x_offset + lwidth, y_offset + label.getSize(), shadeWidth, sUnit, unit, VoidMeiMain.colorUnit);
	}
	// BOS 类型的标签
